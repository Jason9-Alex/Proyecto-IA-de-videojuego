...
def get_best_greedy_move(board, hand_red, empty_cells, rows, cols):
    best_score = -999
...
def get_best_minimax_move(board, hand_red, empty_cells, rows, cols):
    # Por el momento comparte lógica con Greedy, escalable a Alpha-Beta Pruning
    return get_best_greedy_move(board, hand_red, empty_cells, rows, cols)

def select_ai_move(difficulty, board, hand_red, empty_cells, rows, cols):
    if difficulty == 1:
        ...
        return get_best_minimax_move(board, hand_red, empty_cells, rows, cols)